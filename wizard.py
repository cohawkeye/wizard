...
pygame.display.set_caption("Catch the Hats")
...
BLACK = (255, 255, 255)
# Set fonts
font = pygame.font.Font("SageMondialRegular-EaKGj.ttf", 32)

# Set Text
points_text = font.render("Hats: " + str(burger_points), True, GRAY)
...
""" title_text = font.render("Burger Dog", True, GRAY)
